...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto frame = new tsl::elm::OverlayFrame("动态锁帧", getStringID(Lang::Id_FrameskipTester));
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto frame = new tsl::elm::OverlayFrame("动态锁帧", getStringID(Lang::Id_DisplayUnderclockWizard));
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto frame = new tsl::elm::OverlayFrame("动态锁帧", getStringID(Lang::Id_DisplayOverclockWizard));
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        auto frame = new tsl::elm::OverlayFrame("动态锁帧", string_temp);
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto frame = new tsl::elm::OverlayFrame("动态锁帧", getStringID(Lang::Id_DockedDisplayAdditionalSettings));
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto frame = new tsl::elm::OverlayFrame("动态锁帧", getStringID(Lang::Id_DockedDisplaySettings));
...
public:
	...
	virtual tsl::elm::Element* createUI() override {
		...
		auto frame = new tsl::elm::OverlayFrame("动态锁帧", getStringID(Lang::Id_ChangeRefreshRate));
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto frame = new tsl::elm::OverlayFrame("动态锁帧", getStringID(Lang::Id_DisplaySettings));
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto frame = new tsl::elm::OverlayFrame("动态锁帧", getStringID(Lang::Id_DisplaySettingsWarning));
